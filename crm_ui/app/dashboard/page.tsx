...
const quickActions = [
  { name: 'Add Customer', icon: UserPlus, color: 'from-violet-500 to-purple-600' },
  { name: 'Create Order', icon: ShoppingBag, color: 'from-emerald-500 to-teal-600' },
  { name: 'View Reports', icon: TrendingUp, color: 'from-amber-500 to-orange-600' },
  { name: 'Send Message', icon: MessageSquare, color: 'from-cyan-500 to-blue-600' },
];
